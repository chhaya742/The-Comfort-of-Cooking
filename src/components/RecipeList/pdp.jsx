...
const RecipeDetails = () => {
  const { recipeDetails,recipePDP } = useAuth();
  ...
  return (
    <>
      ...
      {recipeDetails.map((item) => {
        return <section key={item.id} className="text-gray-600 body-font overflow-hidden">
          <div className="container px-5 py-16 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src={item.image} />
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 className="text-sm title-font text-gray-500 tracking-widest">The Comfort of Food</h2>
